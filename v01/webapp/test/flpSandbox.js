		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SS Order",
									"targetURL": "#PartnersEditor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PartnersEditor-display": {
								"semanticObject": "PartnersEditor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jetCloud.PartnersEditor",
									"url": sap.ui.require.toUrl("jetCloud/PartnersEditor")
								}
							}
						}
					}
